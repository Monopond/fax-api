...
**Blocklists**||Blocklists|The blocklists that will be checked and filtered against before sending the message. See below for details.WARNING: This feature is inactive and non-functional in this 2.2 version of the Fax API.|
...
WARNING: The blocklist feature is inactive and non-functional in this 2.2 version of the Fax API.
...
## PreviewFaxDocument
### Description
WARNING: This feature is only available in API version 2.1 and above.
